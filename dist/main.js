...
function fetchProducts() {
    fetch("http://localhost:3000/products")
        ...
        data.forEach((product) => {
            ...
            price.textContent = `KSh${product.price ? product.price.toFixed(2) : "0.00"}`;
...
cancelUpdateBtn === null || cancelUpdateBtn === void 0 ? void 0 : cancelUpdateBtn.addEventListener("click", () => {
    updateNameInput.value = "";
    updateDescriptionInput.value = "";
    updatePriceInput.value = "";
    updateCategoryInput.value = "";
